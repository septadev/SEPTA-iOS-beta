...
public class SeptaDraw: NSObject {
    ...
    @objc public dynamic class func drawConnectingDiamondStationView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 10, height: 10), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        bezierPath.addLine(to: CGPoint(x: 5, y: 1))
    ...
    @objc public dynamic class func drawConnectingGradientView(frame: CGRect = CGRect(x: 0, y: 0, width: 15, height: 3)) {
        ...
        //// Rectangle Drawing
        let rectangleRect = CGRect(x: frame.minX, y: frame.minY + fastFloor((frame.height) * 0.00000 + 0.5), width: frame.width, height: frame.height - fastFloor((frame.height) * 0.00000 + 0.5))
        let rectanglePath = UIBezierPath(rect: rectangleRect)
        context.saveGState()
        rectanglePath.addClip()
