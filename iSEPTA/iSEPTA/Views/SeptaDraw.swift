...
public class SeptaDraw : NSObject {
    ...
    @objc dynamic public class func drawBlueGradientView(frame: CGRect = CGRect(x: 17, y: 49, width: 106, height: 59)) {
    ...
    @objc dynamic public class func drawBlueGradientCell(frame: CGRect = CGRect(x: 0, y: 0, width: 76, height: 32), shouldFill: Bool = true, enabled: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawRedButton(frame: CGRect = CGRect(x: 0, y: 0, width: 125, height: 46), redButtonText: String = "Button Text", enabled: Bool = true, buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawVerticalDottedTripGraphic(frame: CGRect = CGRect(x: 21, y: 26, width: 10, height: 52)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!

        //// Color Declarations
        let fillColor = UIColor(red: 0.078, green: 0.294, blue: 0.533, alpha: 1.000)
        let connectingBlueDots = UIColor(red: 0.741, green: 0.804, blue: 0.867, alpha: 1.000)
        let connectingEndpoints = UIColor(red: 0.078, green: 0.294, blue: 0.533, alpha: 1.000)
    ...
    @objc dynamic public class func drawBlueFavoriteIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 22, height: 20), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawSaveButton(frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 25), enabled: Bool = true, buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawDeleteFavorite(frame: CGRect = CGRect(x: 0, y: 0, width: 150, height: 25), enabled: Bool = true, buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawMoreButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 43, height: 22), resizing: ResizingBehavior = .aspectFit, buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawAlertButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit, enabled: Bool = true, buttonHighlighted: Bool = false, isOpen: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawPinkAlertCellHeader(frame: CGRect = CGRect(x: 0, y: 0, width: 10, height: 10), enabled: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawNavBarBackButton(frame: CGRect = CGRect(x: 0, y: 0, width: 13, height: 21)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawViewNextToArriveTripInSchedules(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 130, height: 30), resizing: ResizingBehavior = .aspectFit, buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 130, height: 30), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 130, y: resizedFrame.height / 30)
        ...
        //// Text Drawing
        let textRect = CGRect(x: 26.15, y: 9, width: 104, height: 13.57)
        ...
        let highlightRectanglePath = UIBezierPath(roundedRect: CGRect(x: 0, y: 0, width: 130.15, height: 30), cornerRadius: 3)
        buttonHighlightedColor.setFill()
        highlightRectanglePath.fill()
        
        context.restoreGState()

    }

    @objc dynamic public class func drawRefreshNextToArriveButton(frame: CGRect = CGRect(x: 0, y: 0, width: 75, height: 25), buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: frame.minX + 55.04, y: frame.minY + 13.96))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 59.69, y: frame.minY + 5.32), controlPoint1: CGPoint(x: frame.minX + 54.28, y: frame.minY + 10.32), controlPoint2: CGPoint(x: frame.minX + 56.23, y: frame.minY + 6.69))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 68.47, y: frame.minY + 7.64), controlPoint1: CGPoint(x: frame.minX + 62.85, y: frame.minY + 4.06), controlPoint2: CGPoint(x: frame.minX + 66.4, y: frame.minY + 5.05))
        bezierPath.addLine(to: CGPoint(x: frame.minX + 66.68, y: frame.minY + 7.38))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 66.19, y: frame.minY + 7.74), controlPoint1: CGPoint(x: frame.minX + 66.45, y: frame.minY + 7.34), controlPoint2: CGPoint(x: frame.minX + 66.22, y: frame.minY + 7.51))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 66.55, y: frame.minY + 8.23), controlPoint1: CGPoint(x: frame.minX + 66.15, y: frame.minY + 7.98), controlPoint2: CGPoint(x: frame.minX + 66.32, y: frame.minY + 8.2))
        bezierPath.addLine(to: CGPoint(x: frame.minX + 69.33, y: frame.minY + 8.64))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 69.4, y: frame.minY + 8.65), controlPoint1: CGPoint(x: frame.minX + 69.35, y: frame.minY + 8.65), controlPoint2: CGPoint(x: frame.minX + 69.37, y: frame.minY + 8.65))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 69.65, y: frame.minY + 8.56), controlPoint1: CGPoint(x: frame.minX + 69.49, y: frame.minY + 8.65), controlPoint2: CGPoint(x: frame.minX + 69.58, y: frame.minY + 8.62))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 69.82, y: frame.minY + 8.28), controlPoint1: CGPoint(x: frame.minX + 69.75, y: frame.minY + 8.49), controlPoint2: CGPoint(x: frame.minX + 69.81, y: frame.minY + 8.39))
        bezierPath.addLine(to: CGPoint(x: frame.minX + 70.23, y: frame.minY + 5.5))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 69.87, y: frame.minY + 5.01), controlPoint1: CGPoint(x: frame.minX + 70.27, y: frame.minY + 5.27), controlPoint2: CGPoint(x: frame.minX + 70.11, y: frame.minY + 5.05))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 69.38, y: frame.minY + 5.38), controlPoint1: CGPoint(x: frame.minX + 69.64, y: frame.minY + 4.98), controlPoint2: CGPoint(x: frame.minX + 69.42, y: frame.minY + 5.14))
        bezierPath.addLine(to: CGPoint(x: frame.minX + 69.13, y: frame.minY + 7.09))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 59.37, y: frame.minY + 4.52), controlPoint1: CGPoint(x: frame.minX + 66.82, y: frame.minY + 4.21), controlPoint2: CGPoint(x: frame.minX + 62.88, y: frame.minY + 3.12))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 54.19, y: frame.minY + 14.14), controlPoint1: CGPoint(x: frame.minX + 55.53, y: frame.minY + 6.04), controlPoint2: CGPoint(x: frame.minX + 53.35, y: frame.minY + 10.09))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 54.61, y: frame.minY + 14.48), controlPoint1: CGPoint(x: frame.minX + 54.23, y: frame.minY + 14.34), controlPoint2: CGPoint(x: frame.minX + 54.41, y: frame.minY + 14.48))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 54.7, y: frame.minY + 14.47), controlPoint1: CGPoint(x: frame.minX + 54.64, y: frame.minY + 14.48), controlPoint2: CGPoint(x: frame.minX + 54.67, y: frame.minY + 14.48))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 55.04, y: frame.minY + 13.96), controlPoint1: CGPoint(x: frame.minX + 54.93, y: frame.minY + 14.42), controlPoint2: CGPoint(x: frame.minX + 55.08, y: frame.minY + 14.19))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: frame.minX + 70.83, y: frame.minY + 10.69))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 70.32, y: frame.minY + 10.35), controlPoint1: CGPoint(x: frame.minX + 70.78, y: frame.minY + 10.45), controlPoint2: CGPoint(x: frame.minX + 70.55, y: frame.minY + 10.3))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 69.98, y: frame.minY + 10.86), controlPoint1: CGPoint(x: frame.minX + 70.09, y: frame.minY + 10.4), controlPoint2: CGPoint(x: frame.minX + 69.94, y: frame.minY + 10.63))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 65.33, y: frame.minY + 19.51), controlPoint1: CGPoint(x: frame.minX + 70.74, y: frame.minY + 14.5), controlPoint2: CGPoint(x: frame.minX + 68.79, y: frame.minY + 18.14))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 56.55, y: frame.minY + 17.18), controlPoint1: CGPoint(x: frame.minX + 62.17, y: frame.minY + 20.76), controlPoint2: CGPoint(x: frame.minX + 58.62, y: frame.minY + 19.78))
        bezierPath.addLine(to: CGPoint(x: frame.minX + 58.33, y: frame.minY + 17.45))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 58.82, y: frame.minY + 17.08), controlPoint1: CGPoint(x: frame.minX + 58.57, y: frame.minY + 17.48), controlPoint2: CGPoint(x: frame.minX + 58.79, y: frame.minY + 17.32))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 58.46, y: frame.minY + 16.59), controlPoint1: CGPoint(x: frame.minX + 58.86, y: frame.minY + 16.85), controlPoint2: CGPoint(x: frame.minX + 58.7, y: frame.minY + 16.63))
        bezierPath.addLine(to: CGPoint(x: frame.minX + 55.68, y: frame.minY + 16.18))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 55.36, y: frame.minY + 16.26), controlPoint1: CGPoint(x: frame.minX + 55.57, y: frame.minY + 16.17), controlPoint2: CGPoint(x: frame.minX + 55.45, y: frame.minY + 16.19))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 55.19, y: frame.minY + 16.54), controlPoint1: CGPoint(x: frame.minX + 55.27, y: frame.minY + 16.33), controlPoint2: CGPoint(x: frame.minX + 55.21, y: frame.minY + 16.43))
        bezierPath.addLine(to: CGPoint(x: frame.minX + 54.78, y: frame.minY + 19.32))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 55.14, y: frame.minY + 19.81), controlPoint1: CGPoint(x: frame.minX + 54.75, y: frame.minY + 19.56), controlPoint2: CGPoint(x: frame.minX + 54.91, y: frame.minY + 19.78))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 55.21, y: frame.minY + 19.82), controlPoint1: CGPoint(x: frame.minX + 55.17, y: frame.minY + 19.82), controlPoint2: CGPoint(x: frame.minX + 55.19, y: frame.minY + 19.82))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 55.63, y: frame.minY + 19.45), controlPoint1: CGPoint(x: frame.minX + 55.42, y: frame.minY + 19.82), controlPoint2: CGPoint(x: frame.minX + 55.6, y: frame.minY + 19.66))
        bezierPath.addLine(to: CGPoint(x: frame.minX + 55.89, y: frame.minY + 17.73))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 62.51, y: frame.minY + 20.91), controlPoint1: CGPoint(x: frame.minX + 57.52, y: frame.minY + 19.77), controlPoint2: CGPoint(x: frame.minX + 59.97, y: frame.minY + 20.91))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 65.65, y: frame.minY + 20.31), controlPoint1: CGPoint(x: frame.minX + 63.55, y: frame.minY + 20.91), controlPoint2: CGPoint(x: frame.minX + 64.62, y: frame.minY + 20.72))
        bezierPath.addCurve(to: CGPoint(x: frame.minX + 70.83, y: frame.minY + 10.69), controlPoint1: CGPoint(x: frame.minX + 69.49, y: frame.minY + 18.79), controlPoint2: CGPoint(x: frame.minX + 71.67, y: frame.minY + 14.74))
        bezierPath.close()
        fillColor2.setFill()
        bezierPath.fill()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: frame.minX + 55.04, y: frame.minY + 13.96))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 59.69, y: frame.minY + 5.32), controlPoint1: CGPoint(x: frame.minX + 54.28, y: frame.minY + 10.32), controlPoint2: CGPoint(x: frame.minX + 56.23, y: frame.minY + 6.69))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 68.47, y: frame.minY + 7.64), controlPoint1: CGPoint(x: frame.minX + 62.85, y: frame.minY + 4.06), controlPoint2: CGPoint(x: frame.minX + 66.4, y: frame.minY + 5.05))
        bezier2Path.addLine(to: CGPoint(x: frame.minX + 66.68, y: frame.minY + 7.38))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 66.19, y: frame.minY + 7.74), controlPoint1: CGPoint(x: frame.minX + 66.45, y: frame.minY + 7.34), controlPoint2: CGPoint(x: frame.minX + 66.22, y: frame.minY + 7.51))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 66.55, y: frame.minY + 8.23), controlPoint1: CGPoint(x: frame.minX + 66.15, y: frame.minY + 7.98), controlPoint2: CGPoint(x: frame.minX + 66.32, y: frame.minY + 8.2))
        bezier2Path.addLine(to: CGPoint(x: frame.minX + 69.33, y: frame.minY + 8.64))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 69.4, y: frame.minY + 8.65), controlPoint1: CGPoint(x: frame.minX + 69.35, y: frame.minY + 8.65), controlPoint2: CGPoint(x: frame.minX + 69.37, y: frame.minY + 8.65))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 69.65, y: frame.minY + 8.56), controlPoint1: CGPoint(x: frame.minX + 69.49, y: frame.minY + 8.65), controlPoint2: CGPoint(x: frame.minX + 69.58, y: frame.minY + 8.62))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 69.82, y: frame.minY + 8.28), controlPoint1: CGPoint(x: frame.minX + 69.75, y: frame.minY + 8.49), controlPoint2: CGPoint(x: frame.minX + 69.81, y: frame.minY + 8.39))
        bezier2Path.addLine(to: CGPoint(x: frame.minX + 70.23, y: frame.minY + 5.5))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 69.87, y: frame.minY + 5.01), controlPoint1: CGPoint(x: frame.minX + 70.27, y: frame.minY + 5.27), controlPoint2: CGPoint(x: frame.minX + 70.11, y: frame.minY + 5.05))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 69.38, y: frame.minY + 5.38), controlPoint1: CGPoint(x: frame.minX + 69.64, y: frame.minY + 4.98), controlPoint2: CGPoint(x: frame.minX + 69.42, y: frame.minY + 5.14))
        bezier2Path.addLine(to: CGPoint(x: frame.minX + 69.13, y: frame.minY + 7.09))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 59.37, y: frame.minY + 4.52), controlPoint1: CGPoint(x: frame.minX + 66.82, y: frame.minY + 4.21), controlPoint2: CGPoint(x: frame.minX + 62.88, y: frame.minY + 3.12))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 54.19, y: frame.minY + 14.14), controlPoint1: CGPoint(x: frame.minX + 55.53, y: frame.minY + 6.04), controlPoint2: CGPoint(x: frame.minX + 53.35, y: frame.minY + 10.09))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 54.61, y: frame.minY + 14.48), controlPoint1: CGPoint(x: frame.minX + 54.23, y: frame.minY + 14.34), controlPoint2: CGPoint(x: frame.minX + 54.41, y: frame.minY + 14.48))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 54.7, y: frame.minY + 14.47), controlPoint1: CGPoint(x: frame.minX + 54.64, y: frame.minY + 14.48), controlPoint2: CGPoint(x: frame.minX + 54.67, y: frame.minY + 14.48))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 55.04, y: frame.minY + 13.96), controlPoint1: CGPoint(x: frame.minX + 54.93, y: frame.minY + 14.42), controlPoint2: CGPoint(x: frame.minX + 55.08, y: frame.minY + 14.19))
        bezier2Path.close()
        bezier2Path.move(to: CGPoint(x: frame.minX + 70.83, y: frame.minY + 10.69))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 70.32, y: frame.minY + 10.35), controlPoint1: CGPoint(x: frame.minX + 70.78, y: frame.minY + 10.45), controlPoint2: CGPoint(x: frame.minX + 70.55, y: frame.minY + 10.3))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 69.98, y: frame.minY + 10.86), controlPoint1: CGPoint(x: frame.minX + 70.09, y: frame.minY + 10.4), controlPoint2: CGPoint(x: frame.minX + 69.94, y: frame.minY + 10.63))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 65.33, y: frame.minY + 19.51), controlPoint1: CGPoint(x: frame.minX + 70.74, y: frame.minY + 14.5), controlPoint2: CGPoint(x: frame.minX + 68.79, y: frame.minY + 18.14))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 56.55, y: frame.minY + 17.18), controlPoint1: CGPoint(x: frame.minX + 62.17, y: frame.minY + 20.76), controlPoint2: CGPoint(x: frame.minX + 58.62, y: frame.minY + 19.78))
        bezier2Path.addLine(to: CGPoint(x: frame.minX + 58.33, y: frame.minY + 17.45))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 58.82, y: frame.minY + 17.08), controlPoint1: CGPoint(x: frame.minX + 58.57, y: frame.minY + 17.48), controlPoint2: CGPoint(x: frame.minX + 58.79, y: frame.minY + 17.32))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 58.46, y: frame.minY + 16.59), controlPoint1: CGPoint(x: frame.minX + 58.86, y: frame.minY + 16.85), controlPoint2: CGPoint(x: frame.minX + 58.7, y: frame.minY + 16.63))
        bezier2Path.addLine(to: CGPoint(x: frame.minX + 55.68, y: frame.minY + 16.18))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 55.36, y: frame.minY + 16.26), controlPoint1: CGPoint(x: frame.minX + 55.57, y: frame.minY + 16.17), controlPoint2: CGPoint(x: frame.minX + 55.45, y: frame.minY + 16.19))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 55.19, y: frame.minY + 16.54), controlPoint1: CGPoint(x: frame.minX + 55.27, y: frame.minY + 16.33), controlPoint2: CGPoint(x: frame.minX + 55.21, y: frame.minY + 16.43))
        bezier2Path.addLine(to: CGPoint(x: frame.minX + 54.78, y: frame.minY + 19.32))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 55.14, y: frame.minY + 19.81), controlPoint1: CGPoint(x: frame.minX + 54.75, y: frame.minY + 19.56), controlPoint2: CGPoint(x: frame.minX + 54.91, y: frame.minY + 19.78))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 55.21, y: frame.minY + 19.82), controlPoint1: CGPoint(x: frame.minX + 55.17, y: frame.minY + 19.82), controlPoint2: CGPoint(x: frame.minX + 55.19, y: frame.minY + 19.82))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 55.63, y: frame.minY + 19.45), controlPoint1: CGPoint(x: frame.minX + 55.42, y: frame.minY + 19.82), controlPoint2: CGPoint(x: frame.minX + 55.6, y: frame.minY + 19.66))
        bezier2Path.addLine(to: CGPoint(x: frame.minX + 55.89, y: frame.minY + 17.73))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 62.51, y: frame.minY + 20.91), controlPoint1: CGPoint(x: frame.minX + 57.52, y: frame.minY + 19.77), controlPoint2: CGPoint(x: frame.minX + 59.97, y: frame.minY + 20.91))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 65.65, y: frame.minY + 20.31), controlPoint1: CGPoint(x: frame.minX + 63.55, y: frame.minY + 20.91), controlPoint2: CGPoint(x: frame.minX + 64.62, y: frame.minY + 20.72))
        bezier2Path.addCurve(to: CGPoint(x: frame.minX + 70.83, y: frame.minY + 10.69), controlPoint1: CGPoint(x: frame.minX + 69.49, y: frame.minY + 18.79), controlPoint2: CGPoint(x: frame.minX + 71.67, y: frame.minY + 14.74))
        bezier2Path.close()
        ...
        //// Text Drawing
        let textRect = CGRect(x: frame.minX + 4, y: frame.minY + 8, width: 44.51, height: 10.05)
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: frame.minX, y: frame.minY, width: 75, height: 25), cornerRadius: 3)
        buttonHighlightedColor.setFill()
        rectanglePath.fill()
    }

    @objc dynamic public class func drawRefreshNextToArriveButton2(frame: CGRect = CGRect(x: 0, y: 0, width: 68, height: 25), buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawCurvedTopView(frame: CGRect = CGRect(x: 0, y: 0, width: 90, height: 43)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawBlueGradientHeader(frame: CGRect = CGRect(x: 0, y: 0, width: 100, height: 100)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawAlertView(alertViewFrame: CGRect = CGRect(x: 0, y: 0, width: 100, height: 100)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawReverseTripButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 70, height: 30), resizing: ResizingBehavior = .aspectFit, buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 70, height: 30), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 70, y: resizedFrame.height / 30)
        ...
        //// background Drawing
        let backgroundPath = UIBezierPath(roundedRect: CGRect(x: 0, y: 0, width: 70, height: 30), cornerRadius: 3)
        buttonHighlightedColor.setFill()
        backgroundPath.fill()


        //// nextToArriveLabel Drawing
        let nextToArriveLabelRect = CGRect(x: 0, y: 0, width: 48.5, height: 30)
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 60.7, y: 6.5))
        bezierPath.addLine(to: CGPoint(x: 60.7, y: 24.5))
        bezierPath.addLine(to: CGPoint(x: 65.7, y: 20.46))
        bezierPath.addLine(to: CGPoint(x: 65.17, y: 19.7))
        bezierPath.addLine(to: CGPoint(x: 61.64, y: 22.55))
        bezierPath.addLine(to: CGPoint(x: 61.64, y: 6.5))
        bezierPath.addLine(to: CGPoint(x: 60.7, y: 6.5))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        fillColor.setFill()
        bezierPath.fill()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 60.7, y: 6.5))
        bezier2Path.addLine(to: CGPoint(x: 60.7, y: 24.5))
        bezier2Path.addLine(to: CGPoint(x: 65.7, y: 20.46))
        bezier2Path.addLine(to: CGPoint(x: 65.17, y: 19.7))
        bezier2Path.addLine(to: CGPoint(x: 61.64, y: 22.55))
        bezier2Path.addLine(to: CGPoint(x: 61.64, y: 6.5))
        bezier2Path.addLine(to: CGPoint(x: 60.7, y: 6.5))
        bezier2Path.close()
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 51.7, y: 10.55))
        bezier3Path.addLine(to: CGPoint(x: 52.22, y: 11.31))
        bezier3Path.addLine(to: CGPoint(x: 55.77, y: 8.46))
        bezier3Path.addLine(to: CGPoint(x: 55.77, y: 24.5))
        bezier3Path.addLine(to: CGPoint(x: 56.7, y: 24.5))
        bezier3Path.addLine(to: CGPoint(x: 56.7, y: 6.5))
        bezier3Path.addLine(to: CGPoint(x: 51.7, y: 10.55))
        bezier3Path.close()
        bezier3Path.usesEvenOddFillRule = true
        fillColor.setFill()
        bezier3Path.fill()
        ...
        //// Bezier 4 Drawing
        let bezier4Path = UIBezierPath()
        bezier4Path.move(to: CGPoint(x: 51.7, y: 10.55))
        bezier4Path.addLine(to: CGPoint(x: 52.22, y: 11.31))
        bezier4Path.addLine(to: CGPoint(x: 55.77, y: 8.46))
        bezier4Path.addLine(to: CGPoint(x: 55.77, y: 24.5))
        bezier4Path.addLine(to: CGPoint(x: 56.7, y: 24.5))
        bezier4Path.addLine(to: CGPoint(x: 56.7, y: 6.5))
        bezier4Path.addLine(to: CGPoint(x: 51.7, y: 10.55))
        bezier4Path.close()
        strokeColor.setStroke()
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 20, height: 20), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier 2 Drawing
        context.saveGState()
        context.translateBy(x: 10.01, y: 10)
        context.rotate(by: -481.87 * CGFloat.pi/180)

        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 6.01, y: 0))
        bezier2Path.addCurve(to: CGPoint(x: 0.01, y: 6), controlPoint1: CGPoint(x: 6.01, y: 3.32), controlPoint2: CGPoint(x: 3.32, y: 6))
        bezier2Path.addCurve(to: CGPoint(x: -5.99, y: 0), controlPoint1: CGPoint(x: -3.3, y: 6), controlPoint2: CGPoint(x: -5.99, y: 3.32))
        bezier2Path.addCurve(to: CGPoint(x: 0.01, y: -6), controlPoint1: CGPoint(x: -5.99, y: -3.31), controlPoint2: CGPoint(x: -3.3, y: -6))
        bezier2Path.addCurve(to: CGPoint(x: 6.01, y: 0), controlPoint1: CGPoint(x: 3.32, y: -6), controlPoint2: CGPoint(x: 6.01, y: -3.31))
        bezier2Path.close()
        bezier2Path.move(to: CGPoint(x: 0.01, y: -10))
        bezier2Path.addLine(to: CGPoint(x: 0.01, y: -6))
        fillColor.setStroke()
        bezier2Path.lineWidth = 1
        bezier2Path.stroke()
    ...
    @objc dynamic public class func drawPerksBackground(frame: CGRect = CGRect(x: 0, y: 0, width: 55, height: 22)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!

        //// Color Declarations
        let perksLeft = UIColor(red: 0.000, green: 0.176, blue: 0.376, alpha: 1.000)
        let perksRight = UIColor(red: 0.000, green: 0.306, blue: 0.651, alpha: 1.000)

        //// Gradient Declarations
        let perksGradient = CGGradient(colorsSpace: nil, colors: [perksLeft.cgColor, perksRight.cgColor] as CFArray, locations: [0, 1])!
        ...
        context.saveGState()
        rectanglePath.addClip()
        context.drawLinearGradient(perksGradient,
            start: CGPoint(x: rectangleRect.maxX, y: rectangleRect.midY),
            end: CGPoint(x: rectangleRect.minX, y: rectangleRect.midY),
            options: [])
        context.restoreGState()
    ...
    @objc dynamic public class func drawNextToArriveButton(buttonFrame: CGRect = CGRect(x: 0, y: -0, width: 250, height: 100), buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawConnectingDiamondStationView(frame: CGRect = CGRect(x: 0, y: 0, width: 10, height: 10)) {
        //// Color Declarations
        let connectingEndpoints = UIColor(red: 0.078, green: 0.294, blue: 0.533, alpha: 1.000)
    ...
    @objc dynamic public class func drawConnectingGradientView(frame: CGRect = CGRect(x: 0, y: 0, width: 15, height: 3)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawConnectingFlatDividerView(frame: CGRect = CGRect(x: 0, y: 0, width: 20, height: 1)) {
        //// Color Declarations
    ...
    @objc dynamic public class func drawConnectingBentDividerViewLeft(frame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 11)) {
        //// Color Declarations
        let connectingDividerColor = UIColor(red: 0.855, green: 0.855, blue: 0.855, alpha: 1.000)
    ...
    @objc dynamic public class func drawConnectingBentDividerViewRight(frame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 11)) {
        //// Color Declarations
        let connectingDividerColor = UIColor(red: 0.855, green: 0.855, blue: 0.855, alpha: 1.000)
    ...
    @objc dynamic public class func drawBigBlueChevron(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 11, height: 18), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawCustomerServiceCell(frame: CGRect = CGRect(x: 0, y: 0, width: 100, height: 60), buttonHighlighted: Bool = false, showChevron: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
    ...
    @objc dynamic public class func drawConnectGradientView(frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!

        //// Color Declarations
        let connectGradientLeft = UIColor(red: 0.871, green: 0.933, blue: 1.000, alpha: 1.000)
        let connectGradientRight = UIColor(red: 0.976, green: 0.988, blue: 1.000, alpha: 1.000)

        //// Gradient Declarations
        let connectGradient = CGGradient(colorsSpace: nil, colors: [connectGradientLeft.cgColor, connectGradientRight.cgColor] as CFArray, locations: [0, 1])!
        ...
        context.saveGState()
        rectanglePath.addClip()
        context.drawLinearGradient(connectGradient,
            start: CGPoint(x: rectangleRect.maxX, y: rectangleRect.midY),
            end: CGPoint(x: rectangleRect.minX, y: rectangleRect.midY),
            options: [])
        context.restoreGState()
