...
public class SeptaDraw: NSObject {
    ...
    @objc public dynamic class func drawBlueGradientTitleView(frame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 100)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc public dynamic class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 20, height: 20), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc public dynamic class func drawPerksBackground(frame: CGRect = CGRect(x: 0, y: 0, width: 55, height: 22)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc public dynamic class func drawCustomerServiceCell(frame: CGRect = CGRect(x: 0, y: 0, width: 100, height: 60), buttonHighlighted: Bool = false, showChevron: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
    ...
    @objc public dynamic class func drawConnectGradientView(frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc public dynamic class func drawLittleBlueChevron(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 22, height: 22), resizing: ResizingBehavior = .aspectFit, buttonHighlighted: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 8.39, y: 6.34))
        bezierPath.addLine(to: CGPoint(x: 13.25, y: 11.5))
        bezierPath.addLine(to: CGPoint(x: 8.39, y: 16.61))
        blueTextColor.setStroke()
        bezierPath.lineWidth = 1
        bezierPath.stroke()
