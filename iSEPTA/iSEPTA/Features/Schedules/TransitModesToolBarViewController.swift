...
class TransitModesToolbarViewController: UIViewController {
    ...
    //    }
    //
    //    override func didMove(toParentViewController _: UIViewController?) {
    //        view.backgroundColor = UIColor.red
    //    }
    //
    //    override func viewDidAppear(_: Bool) {
    //        let count = view.subviews.count
    //        let scount = scrollbar.subviews.count
    //    }
    //
    //    func subscribe() {
    ...
    //    }
    //
    //    func intializeToolbar(transitMode _: TransitMode) {
    //        let count = transitModesToolbarElements.count
