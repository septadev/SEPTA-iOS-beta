...
public class FindStopCommand: BaseCommand {
    public typealias TripStartCommandCompletion = ([Stop]?, Error?) -> Void
    public static let sharedInstance = FindStopCommand()

    private override init() {}

    public func stops(forTransitMode transitMode: TransitMode, forStopId stopId: Int, completion: @escaping TripStartCommandCompletion) {
        let sqlQuery = FindStopSQLQuery(transitMode: transitMode, stopId: stopId)
