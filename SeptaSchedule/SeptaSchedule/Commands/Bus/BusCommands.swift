...
public class BusCommands: BaseCommand {
    ...
    public func busRoutes(withQuery _: SQLQuery, completion _: @escaping BusRoutesCompletion) {

        //        retrieveResults(sqlQuery: SQLQueryProtocol, userCompletion: completion) { (statement) -> [Route] in
        //            var routes = [Route]()
    ...
    public func busStops(withQuery _: SQLQuery, completion _: @escaping BusStopsCompletion) {
    ...
    public func busTrips(withQuery _: SQLQuery, completion _: @escaping BusTripsCompletion) {
        /*
