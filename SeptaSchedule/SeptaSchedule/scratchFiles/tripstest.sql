...
JOIN trips_rail T
ON ST.trip_id = T.trip_id
WHERE ST.stop_id = 90006 AND T.service_id = 2 and T.direction_id = 1) Start
...
JOIN trips_rail T
ON ST.trip_id = T.trip_id
WHERE  stop_id = 90522 AND T.service_id = 2 and T.direction_id = 1) Stop
