...
class Test_CKContainer_Swift: XCTestCase {
    ...
    func test_requestApplicationPermission() {
        class MockContainer: CKContainer {
            ...
            override func requestApplicationPermission(_: CKApplicationPermissions, completionHandler: @escaping CKApplicationPermissionBlock) {
    ...
    func test_statusForApplicationPermission() {
        class MockContainer: CKContainer {
            ...
            override func status(forApplicationPermission _: CKApplicationPermissions, completionHandler: @escaping CKApplicationPermissionBlock) {
                completionHandler(.granted, nil)
            }
        }
    ...
    func test_discoverUserInfoWithEmailAddress() {
        class MockContainer: CKContainer {
            ...
            override func discoverUserInfo(withEmailAddress _: String, completionHandler: @escaping (CKDiscoveredUserInfo?, Error?) -> Void) {
                completionHandler(PMKDiscoveredUserInfo(), nil)
            }
        }
    ...
    func test_discoverUserInfoWithRecordID() {
        class MockContainer: CKContainer {
            ...
            override func discoverUserInfo(withUserRecordID _: CKRecordID, completionHandler: @escaping (CKDiscoveredUserInfo?, Error?) -> Void) {
                completionHandler(PMKDiscoveredUserInfo(), nil)
            }
        }
