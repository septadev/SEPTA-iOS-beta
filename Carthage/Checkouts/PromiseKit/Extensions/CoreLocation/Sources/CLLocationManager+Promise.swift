import CoreLocation.CLLocationManager
    ...
    private class LocationManager: CLLocationManager, CLLocationManagerDelegate {
        ...
        private class AuthorizationCatcher: CLLocationManager, CLLocationManagerDelegate {
            ...
            @objc fileprivate func locationManager(_: CLLocationManager, didChangeAuthorization status: CLAuthorizationStatus) {
                if status != .notDetermined {
                    fulfill(status)
                    retainCycle = nil
                }
        ...
        private func auther(_: CLLocationManager.RequestAuthorizationType) -> (CLLocationManager) -> Void {
            return { _ in }
        }
