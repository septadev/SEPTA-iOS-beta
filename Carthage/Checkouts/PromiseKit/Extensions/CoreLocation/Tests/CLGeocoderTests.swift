...
class CLGeocoderTests: XCTestCase {
    func test_reverseGeocodeLocation() {
        class MockGeocoder: CLGeocoder {
            override func reverseGeocodeLocation(_: CLLocation, completionHandler: @escaping CLGeocodeCompletionHandler) {
    ...
    func test_geocodeAddressDictionary() {
        class MockGeocoder: CLGeocoder {
            override func geocodeAddressDictionary(_: [AnyHashable: Any], completionHandler: @escaping CLGeocodeCompletionHandler) {
