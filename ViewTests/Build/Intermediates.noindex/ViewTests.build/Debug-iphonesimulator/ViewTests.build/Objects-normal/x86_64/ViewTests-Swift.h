...
SWIFT_MODULE_NAMESPACE_PUSH("ViewTests")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC9ViewTests11AppDelegate")
...
SWIFT_CLASS("_TtC9ViewTests18NextToArriveButton")
@interface NextToArriveButton : UIButton
...
enum SeptaDrawResizingBehavior : NSInteger;

SWIFT_CLASS("_TtC9ViewTests9SeptaDraw")
...
typedef SWIFT_ENUM_NAMED(NSInteger, SeptaDrawResizingBehavior, "ResizingBehavior") {
  SeptaDrawResizingBehaviorAspectFit = 0,
/// The content is proportionally resized to fit into the target rectangle.
  SeptaDrawResizingBehaviorAspectFill = 1,
/// The content is proportionally resized to completely fill the target rectangle.
  SeptaDrawResizingBehaviorStretch = 2,
/// The content is stretched to match the entire target rectangle.
  SeptaDrawResizingBehaviorCenter = 3,
};
...
SWIFT_CLASS("_TtC9ViewTests14ViewController")
