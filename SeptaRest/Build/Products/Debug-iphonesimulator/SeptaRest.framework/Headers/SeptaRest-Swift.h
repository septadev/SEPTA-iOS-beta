...
SWIFT_MODULE_NAMESPACE_PUSH("SeptaRest")
@class NSCoder;

SWIFT_CLASS("_TtC9SeptaRest11ErrorResult")
@interface ErrorResult : NSError
...
SWIFT_CLASS("_TtC9SeptaRest14SEPTAApiClient")
@interface SEPTAApiClient : NSObject
