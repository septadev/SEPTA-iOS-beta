...
typedef NS_ENUM(NSInteger, CHDecimalPosition)
{
    kCHDecimalPositionNone,
    kCHDecimalPositionTenths = 2,
    kCHDecimalPositionHundredths,
    kCHDecimalPositionThousandths,
    kCHDecimalPositionTenThousandths,
};
...
@property (nonatomic, strong) NSString *value;                              // value represented by the digitViews
...
@property (nonatomic, assign) CHDecimalPosition decimalPosition;
