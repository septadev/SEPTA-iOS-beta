...
@interface OldTrainViewViewController ()

@end

@implementation OldTrainViewViewController
{
...
-(void) loadMapVC
{
    ...
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"KMLMapsStoryboard" bundle:nil];
    KMLMapsViewController *kmVC = (KMLMapsViewController*)[storyboard instantiateInitialViewController];
    
    [kmVC setTravelMode: self.travelMode];
    [kmVC setRouteName: self.routeName];
    [kmVC setRouteType: self.routeType];
